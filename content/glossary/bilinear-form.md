...
A **bilinear form** on a {{< knowl id="vector-space" text="vector space" >}} $V$ over a {{< knowl id="field" text="field" >}} $F$ is a function $B: V \times V \to F$ that is linear in each argument:
